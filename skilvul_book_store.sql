...
-- insert data --
INSERT INTO penulis(nama, kota) VALUES('Dan Brown', 'London');
INSERT INTO penulis(nama, kota) VALUES('Putra H', 'Balige');

INSERT INTO penerbit(nama, kota) VALUES('Erlangga', 'Laguboti');
INSERT INTO penerbit(nama, kota) VALUES('Harianja', 'Porsea');

INSERT INTO buku(ISBN, judul, idPenulis, idPenerbit, harga, stock)
VALUES ('11S18065', 'The Art of Jump', 2, 2, 100000, 50);
INSERT INTO buku(ISBN, judul, idPenulis, idPenerbit, harga, stock)
VALUES ('11S18066', 'The Art of Ang', 2, 1, 150000, 10);
INSERT INTO buku(ISBN, judul, idPenulis, idPenerbit, harga, stock)
VALUES ('111xx1112', 'Angels & Demons', 1, 1, 350000, 120);
